        ...
        <div className="from-card via-card to-muted/20 border-ring/20 relative w-full overflow-hidden rounded-xl border bg-gradient-to-br p-8">
          ...
          <div className="relative text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href={localizeCallToActionHref(locale, primaryButtonHref)}
                className={cn(
                  buttonVariants({size: 'lg'}),
                  'bg-primary hover:bg-primary/90 text-primary-foreground hover:shadow-primary/25 shadow-lg transition-all duration-300 hover:shadow-xl',
                )}
              >
              ...
              <Link
                href={localizeCallToActionHref(locale, secondaryButtonHref)}
                className={cn(
                  buttonVariants({variant: 'outline', size: 'lg'}),
                  'border-ring/30 text-foreground hover:border-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300',
                )}
              >
...
function localizeCallToActionHref(locale: AppLocale, href: string) {
