...
import {Artwork, ArtworkLike, User} from '@prisma/client'
...
export function ArtworkCard({artwork}: ArtworkCardProps) {
  ...
  return (
    <div className="box-border inline-block w-60 rounded-md bg-white bg-[length:400%_400%] p-[0.2rem] duration-150 hover:animate-border hover:bg-gradient-to-r hover:from-primary-500 hover:to-purple-500">
      ...
      <div className="absolute bottom-0 left-0 h-1/2 w-1/2 rounded-full bg-primary-500 bg-opacity-40 blur-md" /> */}
        ...
        {artist && (
          <div className="mb-2 mt-1 flex items-center justify-between text-xs text-background">
          ...
          <>
            ...
            <Social
              socials={[
                {
                  platform: 'twitter',
                  username: 'bektenusubaliev',
                  url: 'https://twitter.com/bektenusubaliev',
                },
                {
                  platform: 'email',
                  username: 'bektenusubaliev@gmail.com',
                  url: 'mailto:bektenusubaliev@gmail.com',
                },
                {
                  platform: 'phone',
                  username: 'bektenusubaliev',
                  url: 'https://facebook.com/bektenusubaliev',
                },
              ]}
